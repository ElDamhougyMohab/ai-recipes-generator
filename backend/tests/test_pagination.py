...
class TestPagination:
    ...
    def test_get_recipes_default_pagination(
        self, client: TestClient, created_multiple_recipes
    ):
    ...
    def test_get_recipes_custom_pagination(
        self, client: TestClient, created_multiple_recipes
    ):
    ...
    def test_get_recipes_max_per_page_limit(
        self, client: TestClient, created_multiple_recipes
    ):
    ...
    def test_get_recipes_invalid_page_number(
        self, client: TestClient, created_multiple_recipes
    ):
    ...
    def test_get_recipes_invalid_per_page(
        self, client: TestClient, created_multiple_recipes
    ):
    ...
    def test_pagination_with_different_per_pages(
        self, client: TestClient, created_multiple_recipes
    ):
        ...
        for per_page in per_pages:
            response = client.get(
                "/api/recipes", params={"page": 1, "per_page": per_page}
            )
            assert response.status_code == 200
