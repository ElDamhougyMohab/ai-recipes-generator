# AI Recipes Generator - ECS Module
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        {
          name      = "DATABASE_URL"
          valueFrom = "arn:aws:ssm:${var.aws_region}:${var.account_id}:parameter/${var.project_name}/${var.environment}/database_url"
        },
        {
          name      = "GEMINI_API_KEY"
          valueFrom = "arn:aws:ssm:${var.aws_region}:${var.account_id}:parameter/${var.project_name}/${var.environment}/gemini_api_key"
        }
      ]
